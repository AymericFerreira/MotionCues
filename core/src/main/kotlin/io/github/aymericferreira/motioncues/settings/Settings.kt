...
enum class PatternStyle {
    /** Dots drift with vehicle motion (the motion-cue effect). */
    DYNAMIC,
 ...
 *
 * @param dotColor packed ARGB color.
...
data class Settings(
    ...
    companion object {
        ...
        val DOT_COUNT_RANGE: IntRange = 8..150
